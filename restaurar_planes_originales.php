<?php
/**
 * Script para restaurar los tipos de inversión originales
 * Ejecuta desde el navegador: http://localhost/CashSpace/restaurar_planes_originales.php
 */
...
$planes_originales = [
    ...
    [
        ...
        'descripcion' => 'El nivel más exclusivo de inversión',
...
// Mostrar todos los planes restaurados
...
echo "<h2>📋 Planes de Inversión Restaurados:</h2>";
echo "<table>";
echo "<tr><th>ID</th><th>Nombre</th><th>Descripción</th><th>Inversión</th><th>Ganancia/Día</th><th>Ganancia/Mes</th><th>Límite</th></tr>";
